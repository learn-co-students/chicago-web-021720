...
def num_points_scored(player_name)
  # get a list of all the players, home and away
  players = get_players
  # find the player whose name matches the argument 'player_name'
  found = find_player(players, player_name)
  # return that player's points
  found[:points]
end

def get_players
  players_on_teams = game_hash.values.map do |team|
    team[:players]
  end
  players = players_on_teams.flatten
end
...
def find_player(collection, name)
  found = collection.find do |player_hash|
