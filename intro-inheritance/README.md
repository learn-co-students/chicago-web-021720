# OO Inheritance and Composition

## OBJECTIVES

- Describe the difference between inheritance and composition
- Implement inheritance between models to DRY out code
- Extract a module with shared model methods to DRY out code
- Use "is a" vs "has a" questioning to determine which option is best
- Practice working with the "super" keyword
